...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:huginn-notify:1.0.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","E:\\work\\jenkins\\huginn-notify-plugin");
    parameters.put("artifactId","huginn-notify");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","E:\\work\\jenkins\\huginn-notify-plugin\\target\\classes");
    parameters.put("testOutputDirectory","E:\\work\\jenkins\\huginn-notify-plugin\\target\\test-classes");
